...
def controller(traj, currentState):
    ...
    middle_speed2 = 20.6
    max_speed = 50;
    if min_index <= 649 or min_index >= 7800:
        desired_speed = max_speed
    elif min_index >= 3000 and min_index <= 5050:
        desired_speed = middle_speed1
    elif min_index >= 5880 and min_index <= 7430:
        desired_speed = middle_speed2
    else:
...
#    
#    speed_future = 500
#    speed_target_index = min_index+speed_future
#    if speed_target_index >= traj.shape[0]:
#        speed_target_index = -1
#    for i in range(min_index,speed_target_index):
#        if(controller.curvature[i]>max_curvature):
#            max_curvature = controller.curvature[i]
#    if max_curvature < 0.001:
#        desired_speed = max_speed
##    elif max_curvature < 0.02:
##        desired_speed = middle_speed
#    else:
#        desired_speed = min_speed
